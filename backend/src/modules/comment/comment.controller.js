 ...
 */
export async function createComment(req, res, _next) {
  try {
 ...
 */
export async function getCommentsByPostId(req, res, _next) {
  try {
    const { postId } = req.params;
 ...
 * PUT /api/comments/:id
 */
export async function updateComment(req, res, _next) {
  try {
    const { id } = req.params;
 ...
 */
export async function deleteComment(req, res, _next) {
  try {
    const { id } = req.params;
